...
# %%
with open(f"./check_point/citedNeighbor{STEP-1}.pkl", "wb") as f:
    pickle.dump(candidates, f)
# %%
with open(f"./check_point/citedNeighbor{STEP-1}.pkl", "rb") as f:
...
# %%
with open(f"./check_point/smallMag{STEP}.pkl", "wb") as f:
