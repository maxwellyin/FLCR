...
class recallSet(Dataset):
    def __init__(self, samples: pd.DataFrame, clusterID: int, transform=None):
    ...
    def __getitem__(self, idx: int):      
        ...
        sample = {'context': _sample['context'], 'clusterID': self.clusterID}
...
class idSet(Dataset):
    ...
    def __getitem__(self, idx: int):      
        ...
        sample = {'context': _sample['context'], 'paperIDsRaw': _sample['paperIDs']}
...
for i in range(5):
    ...
    recallRawSet = recallSet(SAMPLES, clusterID=i)
