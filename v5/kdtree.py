...
import net
# %%
from const import CHECK_NAME, DEVICE, SMALL_MAG, BATCH_SIZE, NUM_WORKERS, CONTEXT_LENGTH, BERT_SIZE, CHECK_POINT, CHECK_STEP
# %%
...
if __name__ == "__main__":
    ...
    with open(f"./check_point/citedMap_{CHECK_NAME}.pkl", "wb") as f:
        pickle.dump(citedMaps.cpu(), f)

    tree = KDTree(citedMaps.cpu(), metric='euclidean')

    with open(f"./check_point/tree_{CHECK_NAME}.pkl", "wb") as f:
        pickle.dump(tree, f)
# %%
