...
BATCH_SIZE = 1000
with open(SCRIPT_DIR / 'dataout' / 'slurm-57272075.out') as f:
    s = f.read()
# %%
...
# %%
with open(ROOT_DIR / "data" / "taskIdx.pkl", "rb") as f:
    tasks = pickle.load(f)
# %%
...
# %%
# 以下 copy 自 build_enriched_samples.py，两处修改
...
OUT_DB = ROOT_DIR / "data" / "samplesEnhance.db"
