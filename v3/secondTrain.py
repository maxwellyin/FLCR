...
class secondCitationSet(Dataset):
    ...
    def __getitem__(self, idx: int):      
        ...
        sample = {'contextRaw': _sample['contextRaw'], 'context': _sample['context'], 'title': title, 'abstract': abstract,'nTitle':neighborTitle, 'nAbstract':neighborAbstract, 'fTitle': fakeTitle, 'fAbstract': fakeAbstract, 'paperIDRaw': paperID}
...
def secondTrain(model: nn.Module, train_loader, optimizer, device = DEVICE):
    ...
    for batch in train_loader:
        ...
        neighbor_pred = model(context, nCited)
