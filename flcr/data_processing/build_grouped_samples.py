...
from flcr.data_processing.const import available_cpu_count
...
NEIGHBOR_NUM = 30
BATCH_SIZE = 1000
SAMPLES_IN = ROOT_DIR / "data" / "samplesTrim.db"
SAMPLES_OUT = ROOT_DIR / "data" / "samplesGroups.db"
SMALL_MAG = ROOT_DIR / "experiments" / "legacy" / "v3" / "check_point" / "smallMag2.pkl"
...
os.system(f"sqlite3 {SAMPLES_OUT} < {SCRIPT_DIR / 'create.sql'}")
